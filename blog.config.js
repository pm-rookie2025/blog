...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '1d2ce973040d80a69e9bce8b3e67b206',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '产品经理', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '互联网软件&AI 方向的产品经理', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://tangly1024.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'AI, 产品, 博客, 产品经理, 互联网', // 网站关键词 英文逗号隔开
  ...
  GREETING_WORDS:
    ...
    '欢迎来到我的产品博客,分享AI与产品的思考,探索科技与人性的边界,用产品连接可能性',
